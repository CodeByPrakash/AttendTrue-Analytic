...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await fetch('/api/auth/register', {
      ...
      body: JSON.stringify({ firstName, lastName, email, password, instituteId }),
    });
    ...
    <div className="container">
      <div className="glass-card">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <label className="form-label" htmlFor="instituteId">Institute ID</label>
          <input id="instituteId" type="text" value={instituteId} onChange={(e) => setInstituteId(e.target.value)} required className="form-input" placeholder="Enter your institute/college ID" />
